...
SIM = dlmread("sorted_selection.txt","\t",1,0);

plot(Ha,SIM(:,1),1000*SIM(:,2),'-bo','linewidth',3,'markersize',4,'markerfacecolor','b');
plot(Ha,SIM(:,1),1000*SIM(:,3),'-ro','linewidth',2,'MarkerSize',3,'makerfacecolor','r');
plot(Ha,SIM(:,1),1000*SIM(:,4),'-go','linewidth',1,'markersize',2,'markerfacecolor','g');
axis([0 100000 0 200]);
...
print('sorted_selection.png','-dpng','-r300');
